...
OpenAI-compatible REST API for chat completions, embeddings, and model management. **inferencia** is hosted on Coolify. Default chat model fallback (when `model` is omitted): **qwen3:6b-bf16**.
